$(document).ready(function() {
  ...
  // Define Canvas
  const canvas = new fabric.Canvas('graphic-editor', {
    selection: true,
  ...
  $('.edit-text-shadow').keyup(function() {
    var shadow = {
  ...
  $('.edit-shape-shadow').keyup(function() {
    var shadow = {
  ...
  function selectedObjectSidebar() {
    ...
    if (selectedObject.length === 1) {
      ...
      if (objectType === 'i-text') {
      ...
      } else if (objectType === 'circle' || objectType === 'rect') {
        ...
        gp.setColorPicker(handler => {
          ...
          $(el).spectrum({
              ...
              move(color) {
                handler.setColor(color.toHexString(), 0);
              }
          });
        });
  ...
  $('#editing-tab').click(function() {
    var selectedObject = canvas.getActiveObjects()
    $('#settings-tab, #layers-tab').hide();
